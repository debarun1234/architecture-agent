...
gcloud run deploy "$SERVICE_NAME" \
  ...
  --set-env-vars "GOOGLE_CLOUD_PROJECT=${PROJECT_ID},GOOGLE_CLOUD_REGION=${REGION},ALLOYDB_CLUSTER=${ALLOYDB_CLUSTER},ALLOYDB_INSTANCE=${ALLOYDB_INSTANCE},ALLOYDB_USER=${ALLOYDB_USER},ALLOYDB_PASS=${ALLOYDB_PASS},ALLOYDB_NAME=${ALLOYDB_NAME}"
